...
# Prosedur untuk menampilkan panduan penggunaan sistem
    ...
    while not stopShow:
        if userType.lower() == "admin":
            ...
            print("================================ HELP ===================================")
            print("1. login - Masuk pada akun untuk mengoperasikan sistem.")
            print("1. list_game_toko - Melihat daftar game yang dijual pada toko")
            print("2. buy_game - Membeli game dari toko.")
            print("3. list_game - Melihat game yang dimiliki.")
            print("4. search_my_game - Mencari game yang dimiliki")
            print("5. search_game_at_store - Mencari game yang dijual pada toko")
            print("6. riwayat - Daftar riwayat pembelian game.")
            print("7. extras - Fitur bonus BNMO.")
            print("8. save - Menyimpan data pada folder yang telah dispesifikasi")
